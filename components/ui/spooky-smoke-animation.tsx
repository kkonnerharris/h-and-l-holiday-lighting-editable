...
class Renderer {
  ...
  private color: [number, number, number] = [0.0, 0.8, 1.0];
  ...
  private init() {
    ...
    (program as unknown as Record<string, unknown>).resolution = gl.getUniformLocation(program, "resolution");
    (program as unknown as Record<string, unknown>).time = gl.getUniformLocation(program, "time");
    (program as unknown as Record<string, unknown>).u_color = gl.getUniformLocation(program, "u_color");
  }
  ...
  render(now = 0) {
    ...
    const p = program as unknown as Record<string, WebGLUniformLocation>;
